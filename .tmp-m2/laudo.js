 ...
 */
import { pct, moeda, SAIDAS, ANEXOS_SIMPLES, } from "./motor.js";
/**
...
export function baseDeCalculo(a) {
    ...
    linhas.push(`Parcela PIS/Cofins que migra para a CBS e sai do DAS: ${pct(d.sharePC)} da carga do Simples = ${pct(d.das)} da receita.`);
    return linhas;
}
...
export function premissasComOrigem(a) {
    ...
    const o = (k) => {
        const v = p.origens?.[k];
        if (v === "informada" || v === "estimada" || v === "padrao")
            return v;
...
export const BASE_LEGAL = [
    ...
    },
    {
        ...
        papel: "regulamentou o IBS e a CBS e disciplinou a apuração pelo optante do Simples, dentro ou fora do documento único de arrecadação.",
    },
    {
