/**
 * PLANOS E ASAAS — deixou de ser rota em 05/08/2026.
 *
 * A pergunta que levava alguém até "Planos & Asaas" é a mesma que leva a
 * "Faturas & régua": como o dinheiro entra. Um plano existe para virar
 * fatura; a chave do Asaas existe para a fatura ser criada. Em duas rotas, a
 * pessoa precisava lembrar em qual das duas estava a coisa — e não lembrava.
 *
 * O conteúdo é o mesmo, agora como seção. A rota antiga redireciona.
 */
...
export async function PlanosEAsaas() {
  ...
  if (n.erro) {
    return (
      <div id="planos" className="scroll-mt-6 rounded-lg border border-amarelo/40 bg-amarelowash p-5">
