...
try {
  ...
  const ARQUIVOS = [
    ...
    "lib/emails-cliente.ts", "lib/erros-auth.ts", "lib/ajuda.ts", "lib/cobranca.ts", "lib/nps.ts", "lib/onboarding.ts",
  ];
...
for (const suite of ["cockpit", "motor", "coleta", "muro", "reguas", "janela", "cnpj", "envio", "erros-auth", "ajuda", "cobranca", "nps", "onboarding"]) {
